...
import type { S as SidebarProps } from 'fumadocs-ui/dist/sidebar-DwBSl7jC';
import { replaceOrDefault } from '@/lib/shared';
import type { LinkItemType } from '@/lib/layouts/link-item';
...
declare const {
    ...
    DynamicSidebar,
    Sidebar,
}: typeof import('fumadocs-ui/dist/docs-layout.client');
