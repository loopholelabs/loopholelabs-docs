...
exported using the `scale fn export` command (see [Exporting Scale Functions](/scale/cli/reference/function#export)).
...
adapters for popular Golang frameworks and libraries, such as [net/http](/scale/languages/golang/adapters/net-http) and [FastHTTP](/scale/languages/golang/adapters/fasthttp).
