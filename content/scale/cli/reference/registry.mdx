...
The 'registry' is used with both [functions](/scale/getting-started/quick-start#create-a-new-function) and [signatures](/scale/signatures/overview), and, as such, the aliases `fn` and `sig` can be used, respectively.
