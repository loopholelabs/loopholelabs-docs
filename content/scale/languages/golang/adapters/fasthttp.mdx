...
you can learn how to import the Scale Function from the Scale Registry using our [Importing Scale Functions](/scale/languages/golang/overview#using-the-registry) guide.
...
<Callout>
    Check out the [Scale CLI](/scale/cli/reference/installation) documentation for more information on how to use the Scale CLI to build and export
    Scale Functions.
</Callout>
