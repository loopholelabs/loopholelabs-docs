...
When you run `scale fn new helloworld:latest`, this is the default signature that is created for, _and_ [_generated_](/scale/signatures/overview#using-a-signature) for you:
